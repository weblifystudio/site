...
const projects = [
  ...
  },
  {
    ...
    description: "Site web professionnel pour cabinet d'avocats avec espace client sécurisé, prise de rendez-vous automatisée, section actualités juridiques et formulaires de contact personnalisés.",
