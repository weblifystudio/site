...
export default function Offres() {
  useEffect(() => {
    ...
    // SEO optimisé pour page offres
    document.title = "Nos Offres Site Web | Tarifs & Devis | Weblify Studio | Noah Delenclos";
    
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', "💰 Découvrez nos offres site web : Site Vitrine 690€, Premium 1290€, E-commerce 2190€. Tarifs transparents, devis gratuit, délai 7j. Calculateur en ligne.");
    }

    // Schema.org FAQPage pour SEO
    const existingScript = document.querySelector('script[data-faq-offres]');
    if (existingScript) {
      existingScript.remove();
    }

    const script = document.createElement('script');
    script.setAttribute('data-faq-offres', 'true');
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-12 max-w-5xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
            Nos <span className="text-primary">offres web</span>
          </h1>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8 leading-relaxed">
            Calculateur intelligent, devis instantané et tarifs transparents. 
            Découvrez notre offre parfaitement adaptée à vos besoins.
          </p>
        </div>
